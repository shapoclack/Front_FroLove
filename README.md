...
Комплексное развёртывание микросервисного приложения с использованием Docker и Docker Compose. Задание является развитием практики 22, где каждый компонент системы теперь изолирован в отдельном контейнере.
